...
import {
  FolderOpen, FileText, CheckCircle2, AlertTriangle, TrendingUp, Send, ChevronRight, Mail
} from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] gap-6 p-6">
      ...
      <div className="text-center max-w-md">
        ...
        <p className="text-slate-500 text-sm leading-relaxed">
          Freelancer'ınızın sizi sisteme eklemesi bekleniyor. Eklendiğinizde e-posta adresinize
          bir davet kodu gelecektir.
        </p>
      </div>

      <div className="w-full max-w-md bg-violet-50 border border-violet-100 rounded-xl p-5">
        <div className="flex items-center gap-3 mb-3">
          <Mail className="w-5 h-5 text-violet-500 flex-shrink-0" />
          <p className="text-sm font-semibold text-violet-700">Davet e-postanızı bekleyin</p>
        </div>
        <p className="text-xs text-violet-600 leading-relaxed">
          Freelancer'ınız sizi sisteme eklediğinde, kayıtlı e-posta adresinize 6 haneli bir
          doğrulama kodu gönderilecektir. Bu kodu{' '}
          <a href="/client-setup" className="underline font-medium">hesap kurulum sayfasında</a>{' '}
          kullanarak portala erişim sağlayabilirsiniz.
        </p>
      </div>
    </div>
  );
