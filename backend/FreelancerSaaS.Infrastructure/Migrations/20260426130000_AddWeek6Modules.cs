...
{
    /// <inheritdoc />
    public partial class AddWeek6Modules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalMessage = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: false),
                    SummarizedTodo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    ApprovedTaskId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientRequests_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientRequests_ProjectTasks_ApprovedTaskId",
                        column: x => x.ApprovedTaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ClientRequests_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientRequests_ApprovedTaskId",
                table: "ClientRequests",
                column: "ApprovedTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientRequests_CustomerId",
                table: "ClientRequests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientRequests_ProjectId",
                table: "ClientRequests",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTaskTags_ProjectTaskId",
