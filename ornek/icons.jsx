// Lucide-style icons (hand-picked subset, stroke-based)
const Icon = ({ d, children, size = 16, stroke = 2, fill = "none", style }) => (
...
const I = {
  ...
  Users: (p) => <Icon {...p}><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><path d="M20 8v6"/><path d="M23 11h-6"/></Icon>,
  Folder: (p) => <Icon {...p}><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></Icon>,
  Kanban: (p) => <Icon {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 7v10"/><path d="M16 7v6"/></Icon>,
  Clock: (p) => <Icon {...p}><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></Icon>,
  Receipt: (p) => <Icon {...p}><path d="M4 2v20l3-2 3 2 3-2 3 2 3-2 3 2V2l-3 2-3-2-3 2-3-2-3 2z"/><path d="M16 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/></Icon>,
  ...
  Building: (p) => <Icon {...p}><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="9" y1="6" x2="9" y2="6.01"/><line x1="15" y1="6" x2="15" y2="6.01"/><line x1="9" y1="10" x2="9" y2="10.01"/><line x1="15" y1="10" x2="15" y2="10.01"/><line x1="9" y1="14" x2="9" y2="14.01"/><line x1="15" y1="14" x2="15" y2="14.01"/><path d="M10 22v-4h4v4"/></Icon>,
  ...
  Square: (p) => <Icon {...p} fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="1"/></Icon>,
